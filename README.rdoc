...
In order to run on anything but +localhost+, change the IP on +line 10+ at +public/javascripts/application.js+ and +line 6+ at +app/views/layouts/application.html.erb+.
